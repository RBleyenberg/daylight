...
### [Demo](https://dare-af252.firebaseapp.com)&nbsp;&nbsp;&nbsp;&nbsp;[RealWorld](https://github.com/gothinkster/realworld)
...
The example application is a social blogging site (i.e. a Medium.com clone) called "dare". It uses a custom API for all requests, including authentication.
